...
{
    /// <summary>
    /// Implements LineSeries2D generator
    /// </summary>
    public class LineSeries2DGeneratorType : ControlGeneratorType
    {
        /// <summary>
        ...
        {
            initMethod.Statements.Insert(index, new CodeExpressionStatement(new CodeMethodInvokeExpression(new CodeFieldReferenceExpression(parent, "Points"), "Add", child)));
        }
    }
}
